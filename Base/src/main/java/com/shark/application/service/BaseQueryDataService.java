...
public abstract class BaseQueryDataService<DataAccessObject, DataTransferObject> extends BaseService<HashMap<String, String>, HashMap<String, String>, DataAccessObject, ResponseDataEntity<DataTransferObject>> {
